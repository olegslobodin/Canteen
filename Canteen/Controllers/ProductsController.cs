...
namespace Canteen.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [Authorize(Roles = "Admin")]
        public ActionResult Create([Bind(Include = "Id,Title,EnergyValue")] Product product)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public ActionResult Edit([Bind(Include = "Id,Title,EnergyValue")] Product product)
        {
            if (ModelState.IsValid)
            {
